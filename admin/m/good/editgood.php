	...
	<form action="?page=good&function=editgood&detail=<?php echo $result['good_id']; ?>" method="post">
		<table>
			...
			<tr class="tr0">
				<td>人气美食</td>
				<td>
					<span><input type="checkbox" name="onsale" value="1"<?php if ($result['onsale'] == 1) echo "checked"; ?>></span>
				</td>
			</tr>
			<tr class="tr1">
				<td>商品名称</td>
			...
			<tr class="tr1">
				<td>在售状态</td>
				<td>
					<span><input type="radio" name="unavail" value="0"<?php if ($result['unavail'] == 0) echo "checked"; ?>>在售</span>
					<span><input type="radio" name="unavail" value="1"<?php if ($result['unavail'] == 1) echo "checked"; ?>>脱销</span>
				</td>
			</tr>
		</table>
		<p class="psubmit">
